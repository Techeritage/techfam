  ...
  return (
    <div className='policy'>
      ...
      <div className='term-full-cont'>
        ...
        <p>
          At TechFam, accessible from https://techfam.online, one of our main priorities is the privacy of our visitors. This Privacy Policy 
          document contains types of information that is collected and recorded by TechFam and how we use it.
        </p>
        <p>
        ...
        <div className='terms-cont'>
          ...
          <p>
            ...
            browser type, Internet Service Provider (ISP), date and time stamp, referring/exit pages, and possibly the number of clicks. These 
        ...
        <div className='terms-cont'>
          ...
          <p>
            ...
            pages on the website that the visitor accessed or visited. The information is used to optimize the users' experience by customizing 
        ...
        <div className='terms-cont'>
          ...
          <p>
            ...
            advertisements and links that appear on TechFam, which are sent directly to users' browser. They automatically receive your IP 
        ...
        <div className='terms-cont'>
          ...
          <p>
            TechFam does not knowingly collect any Personal Identifiable Information from children under the age of 13. If you think that your child
            provided this kind of information on our website, we strongly encourage you to contact us immediately and we will do our best efforts 
